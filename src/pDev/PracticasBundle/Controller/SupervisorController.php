...
class SupervisorController extends Controller
{
     ...
     * Creates a new Supervisor entity.
     *
     * @Route("/create/modal/{organizacionId}", name="practicas_supervisor_create_modal")
     * @Method("POST")
     * @Template("pDevPracticasBundle:Supervisor:newModal.html.twig")
     */
     ...
     * Displays a form to create a new Supervisor entity.
     *
     * @Route("/new/modal/{organizacionId}", name="practicas_supervisor_new_modal")
     * @Method("GET")
     * @Template()
     */
     ...
     * Displays a form to create a new Organizacion entity.
     *
     * @Route("/email/{email}", name="practicas_supervisor_email", options={"expose"=true})
     * @Method("POST")
     */
    public function buscarEmailAction(Request $request, $email)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('pDevPracticasBundle:Supervisor')->findOneByEmail($email);
