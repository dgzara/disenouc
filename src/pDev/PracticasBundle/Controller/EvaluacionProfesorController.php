 ...
 *
 * @Route("/practicas/evaluacion/profesor")
 */
class EvaluacionProfesorController extends Controller
{
     ...
     *
     * @Route("/", name="practicas_evaluacion_profesor")
     * @Template()
     */
     ...
     *
     * @Route("/create/{idPracticante}", name="practicas_evaluacion_profesor_create")
     * @Method("POST")
     * @Template("pDevPracticasBundle:EvaluacionProfesor:new.html.twig")
     */
    public function createAction(Request $request, $idPracticante)
    {
        ...
        $entity->setTipo($practicante->getTipo());
        
        $criteriosTipo = $em->getRepository('pDevPracticasBundle:CriterioTipo')->findBy(array('tipoPractica'=>$practicante->getTipo(), 'tipoEvaluador'=>'Profesor'));
        ...
        $form   = $this->createForm(new EvaluacionProfesorType(), $entity);
        $form->submit($request);
        ...
        if($form->isValid()) 
        {
            ...
            return $this->redirect($this->generateUrl('practicas_evaluacion_profesor_show', array('id' => $entity->getId())));
        }
     ...
     * Displays a form to create a new CriterioTipo entity.
     *
     * @Route("/new/{idPracticante}", name="practicas_evaluacion_profesor_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/descuento", name="practicas_evaluacion_profesor_descuento")
     * @Template()
     */
    public function descuentoAction($id)
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('pDevPracticasBundle:EvaluacionProfesor')->find($id);
        
        if(!$entity){
            throw $this->createNotFoundException('Unable to find AlumnoPracticante entity.');
        }
        
        $form = $this->createForm(new EvaluacionProfesorDescuentoType(), $entity);
        ...
        if($request->isMethod('POST'))
        {
            ...
            if ($form->isValid()) 
            {
                ...
                // Devuelve la ruta
                $array = array('redirect' => $this->generateUrl('practicas_evaluacion_profesor_show',array('id'=>$id))); // data to return via JSON
     ...
     *
     * @Route("/{id}/show", name="practicas_evaluacion_profesor_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="practicas_evaluacion_profesor_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="practicas_evaluacion_profesor_update")
     * @Method("PUT")
     * @Template("pDevPracticasBundle:EvaluacionProfesor:edit.html.twig")
     */
